...
Writes a trajectory to refseqtrain_trajectory.jsonl (one JSON object per line:
...
TRAJECTORY_PATH = "refseqtrain_trajectory.jsonl"
    ...
    for task in tasks[:NUM_TASKS]:
        ...
        async with environment.session(
            ...
            record(
                ...
                expected_answer=task.task_spec["answer"],
